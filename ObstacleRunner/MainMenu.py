...
class MainMenu:
    ...
    def gameIntroButton(self):
        ...
        if 275 + 260 > mouse[0] > 275 and 505 + 50 > mouse[1] > 505:
            ...
            Buttons().buttonBorder(brightGreen, 275, 505, 260, 50)
            if click[0] == 1:
                pygame.quit()
                quit()
        else:
            Buttons().buttonBorder(white, 270, 500, 270, 60)
            Buttons().buttonBorder(green, 275, 505, 260, 50)
        ...
        if 275 + 260 > mouse[0] > 275 and 305 + 50 > mouse[1] > 305:
            ...
            Buttons().buttonBorder(brightGreen, 275, 305, 260, 50)
            if click[0] == 1:
                ControlsPage().controlsPage()
        else:
            Buttons().buttonBorder(white, 270, 300, 270, 60)
            Buttons().buttonBorder(green, 275, 305, 260, 50)
        ...
        if 275 + 260 > mouse[0] > 275 and 205 + 50 > mouse[1] > 205:
            ...
            Buttons().buttonBorder(brightGreen, 275, 205, 260, 50)
           # if click[0] == 1:
                 # self.tutorialPage()
        else:
            Buttons().buttonBorder(white, 270, 200, 270, 60)
            Buttons().buttonBorder(green, 275, 205, 260, 50)
        ...
        if 275 + 260 > mouse[0] > 275 and 105 + 50 > mouse[1] > 105:
            ...
            Buttons().buttonBorder(brightGreen, 275, 105, 260, 50)
            if click[0] == 1:
            ...
            Buttons().buttonBorder(white, 270, 100, 270, 60)
            Buttons().buttonBorder(green, 275, 105, 260, 50)
